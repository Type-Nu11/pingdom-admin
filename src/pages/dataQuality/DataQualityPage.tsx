    ...
    <Shell.AppShell>
      ...
      <Shell.MainArea id={ADMIN_MAIN_SCROLL_AREA_ID}>
        ...
        <Shared.Content><Shared.PageStack>
          ...
          <S.MetricGrid><S.MetricCard><span>조회 범위</span><strong>최근 100건</strong></S.MetricCard><S.MetricCard><span>미해결 이슈</span><strong>{issues.length.toLocaleString()}건</strong></S.MetricCard><S.MetricCard><span>오류</span><strong>{errorCount.toLocaleString()}건</strong></S.MetricCard><S.MetricCard><span>현재 결과</span><strong>{filteredIssues.length.toLocaleString()}건</strong></S.MetricCard></S.MetricGrid>
