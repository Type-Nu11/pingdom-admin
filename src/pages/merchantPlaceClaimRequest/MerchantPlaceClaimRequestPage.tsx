...
function MerchantPlaceClaimRequestPage() {
  ...
  const moveAttachment = async (attachmentId: number, direction: -1 | 1) => {
    ...
    const current = claims.attachments
