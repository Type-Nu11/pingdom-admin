  ...
  return (
    <Shell.AppShell>
      <Shell.SideNav aria-label="관리자 메뉴">
        ...
        <Shell.SideMenu>
          <Shell.MenuButton type="button" onClick={() => navigate('/dashboard')}><Shell.MaterialIcon aria-hidden="true">dashboard</Shell.MaterialIcon><span>대시보드</span></Shell.MenuButton>
        ...
        <Shared.Content>
          <Shared.PageStack>
            <Shared.PageHeader>
              ...
              <Shared.HeaderActions><Shared.HeaderButton type="button" onClick={() => navigate('/main')}>게시글 관리</Shared.HeaderButton></Shared.HeaderActions>
            </Shared.PageHeader>
