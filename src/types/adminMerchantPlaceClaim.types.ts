...
export interface AdminMerchantPlaceClaimAttachment { id: number; documentType: MerchantPlaceClaimAttachmentType; contentType: string; fileSize: number; displayOrder: number }
